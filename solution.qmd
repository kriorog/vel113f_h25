...
A quirk in GLPK is for the units of duals can be inconsistent, i.e. different for duals for different indices of the same constraint. A commercial solver CPLEX (with free academic license) may have more consistent units. The following result and dual analysis is not affected by this GLPK quirk.
