...
# define equality constraints with A_eq and b_eq - add equality constraint for 4% beer
A_eq = [[1, 1, 1, 1],
       p.tolist()]
...
OptimizeResult = linprog(c, A_ub, b_ub, A_eq, b_eq, bounds=bounds, method='interior-point')
